...
2. Use the GitHub Release bundle:
   download `all-api-hub-<version>-safari-xcode-bundle.zip`, extract it, and open the bundled Xcode project directly

The Safari release bundle includes all of the following:
- `all-api-hub-<version>-safari.zip`
- `safari-mv2/`
- the Xcode project generated by `safari-web-extension-converter`

This keeps the Xcode project and compiled Safari files together, so you can open it directly without missing-file errors.
