...
| RightCode | Commercial AI agent relay (right.codes and rightapi.ai are the same service) with its own REST backend rather than a One API / New API derivative. The extension supports account balance and plans, API key management, and the model list with pricing through a dedicated account type. The site offers no check-in, and activation-code redemption is not integrated yet. | [Website](https://www.right.codes/) / [Documentation](https://docs.rightapi.ai/) |
...
<div class="sponsor-list">
  ...
  <section class="sponsor-item">
    ...
    <p>
      <strong>PackyCode</strong> offers relay services for Claude Code, Codex, Gemini, and more. Register using <a href="https://www.packyapi.ai/register?aff=all-api-hub">this link</a> and enter the "all-api-hub" promo code during first recharge to get <strong>10% off</strong> (<a href="./sponsor-guides/packycode.md">setup guide</a>).
    </p>
  </section>
