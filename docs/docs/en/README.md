...
tagline: Open-source browser extension that automatically identifies and manages all AI aggregation proxy accounts, allowing you to view balances, synchronize models, manage keys, and supports cross-platform and cloud backup.
actions:
  - text: Get Started
...
features:
  ...
  - title: Privacy and Security
    details: Operates completely offline, all data is stored locally, and all core features can be used without an internet connection.
...
Currently, there are numerous AI aggregation proxy sites available, and checking balances, model lists, and keys for each one individually can be very cumbersome.
