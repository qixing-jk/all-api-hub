...
/**
 * Reads and parses the built Chromium MV3 manifest.json from `.output/chrome-mv3/`.
 */
export async function getBuiltManifest(): Promise<Record<string, unknown>> {
 ...
 */
export async function getSidePanelPagePath(): Promise<string | null> {
