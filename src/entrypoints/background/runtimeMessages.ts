...
import { applyActionClickBehavior } from "~/src/entrypoints/background/actionClickBehavior"
import { handleAccountKeyRepairMessage } from "~/src/services/accounts/accountKeyAutoProvisioning"
import { handleAutoRefreshMessage } from "~/src/services/accounts/autoRefreshService"
import { handleAutoCheckinMessage } from "~/src/services/checkin/autoCheckin/scheduler"
import { handleExternalCheckInMessage } from "~/src/services/checkin/externalCheckInService"
import { handleDailyBalanceHistoryMessage } from "~/src/services/history/dailyBalanceHistory/scheduler"
import { handleUsageHistoryMessage } from "~/src/services/history/usageHistory/scheduler"
import { handleLdohSiteLookupMessage } from "~/src/services/integrations/ldohSiteLookup/background"
import { handleChannelConfigMessage } from "~/src/services/managedSites/channelConfigStorage"
import { handleManagedSiteModelSyncMessage } from "~/src/services/models/modelSync"
import { handleRedemptionAssistMessage } from "~/src/services/redemption/redemptionAssist"
import { handleWebAiApiCheckMessage } from "~/src/services/verification/webAiApiCheck/background"
import { handleWebdavAutoSyncMessage } from "~/src/services/webdav/webdavAutoSyncService"
