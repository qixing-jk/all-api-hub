...
const withLocalIcon = (
  Icon: ComponentType<ModelVendorIconProps>,
): ModelVendorPresentation => ({ ...GENERIC_VENDOR_PRESENTATION, Icon })
...
const KNOWN_VENDOR_PRESENTATION = {
  ...
  "essential-ai": withLocalIcon(EssentialAI),
  ai2: withLocalIcon(Ai2),
  microsoft: withLocalIcon(Microsoft),
  arcee: withLocalIcon(Arcee),
  "netease-youdao": GENERIC_VENDOR_PRESENTATION,
  baai: withLocalIcon(BAAI),
  "canopy-labs": GENERIC_VENDOR_PRESENTATION,
  "deep-cogito": withLocalIcon(DeepCogito),
  "deep-reinforce": GENERIC_VENDOR_PRESENTATION,
  groq: withLocalIcon(Groq),
  openrouter: withLocalIcon(OpenRouter),
  "kilo-code": withLocalIcon(KiloCode),
  "inclusion-ai": GENERIC_VENDOR_PRESENTATION,
  jina: withLocalIcon(Jina),
  liquid: withLocalIcon(Liquid),
  inception: withLocalIcon(Inception),
  nomic: GENERIC_VENDOR_PRESENTATION,
  amazon: withLocalIcon(Aws),
  sarvam: GENERIC_VENDOR_PRESENTATION,
  sensetime: withLocalIcon(SenseNova),
  upstage: withLocalIcon(Upstage),
  kuaishou: withLocalIcon(Kolors),
  "shanghai-ai-lab": withLocalIcon(InternLM),
  opencode: withLocalIcon(OpenCode),
  "swiss-ai": GENERIC_VENDOR_PRESENTATION,
  sdaia: GENERIC_VENDOR_PRESENTATION,
  "prism-ml": GENERIC_VENDOR_PRESENTATION,
  speakleash: GENERIC_VENDOR_PRESENTATION,
  eurollm: GENERIC_VENDOR_PRESENTATION,
