...
- Add focused validation that exercises modal-contained floating controls, so future layering work cannot silently regress these interactions.

## Capabilities

### New Capabilities
- `ui-layering-hierarchy`: define and enforce separate layering roles for page shell surfaces, modal surfaces, and modal-contained floating overlays.
...
- Validation impact:
  - add focused interaction tests around modal-contained floating layers
