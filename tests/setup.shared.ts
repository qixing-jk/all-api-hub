...
vi.mock("@lobehub/icons", () => {
  ...
  return {
    Ai2: createCompoundedIcon(),
    Alibaba: createCompoundedIcon(),
    Anthropic: createCompoundedIcon(),
    Arcee: createCompoundedIcon(),
    Aws: createCompoundedIcon(),
    Azure: createCompoundedIcon(),
    BAAI: createCompoundedIcon(),
    Baichuan: createCompoundedIcon(),
    Baidu: createCompoundedIcon(),
    ByteDance: createCompoundedIcon(),
    Claude: createCompoundedIcon(),
    Cohere: createCompoundedIcon(),
    DeepCogito: createCompoundedIcon(),
    DeepMind: createCompoundedIcon(),
    DeepSeek: createCompoundedIcon(),
    EssentialAI: createCompoundedIcon(),
    Gemini: createCompoundedIcon(),
    Google: createCompoundedIcon(),
    Groq: createCompoundedIcon(),
    Grok: createCompoundedIcon(),
    LongCat: createCompoundedIcon(),
    Inception: createCompoundedIcon(),
    InternLM: createCompoundedIcon(),
    Jina: createCompoundedIcon(),
    KiloCode: createCompoundedIcon(),
    Kolors: createCompoundedIcon(),
    Liquid: createCompoundedIcon(),
    Meta: createCompoundedIcon(),
    Microsoft: createCompoundedIcon(),
    Minimax: createCompoundedIcon(),
    Mistral: createCompoundedIcon(),
    Moonshot: createCompoundedIcon(),
    NewAPI: createCompoundedIcon(),
    Nvidia: createCompoundedIcon(),
    Ollama: createCompoundedIcon(),
    OpenAI: createCompoundedIcon(),
    OpenCode: createCompoundedIcon(),
    OpenRouter: createCompoundedIcon(),
    Perplexity: createCompoundedIcon(),
    Qwen: createCompoundedIcon(),
    SenseNova: createCompoundedIcon(),
    Stepfun: createCompoundedIcon(),
    Tencent: createCompoundedIcon(),
    Upstage: createCompoundedIcon(),
